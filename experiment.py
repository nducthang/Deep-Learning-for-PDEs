...
PATH_MODEL = './results/test2/'
PATH_LOSS_IMAGE = './results/test2/loss.png'
PATH_L2_ERROR_IMAGE = './results/test2/l2_error.png'
PATH_LOSS_TXT = './results/test2/loss.txt'
PATH_L2_ERROR_TXT = './results/test2/l2_error.txt'
