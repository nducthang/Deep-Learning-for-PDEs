...
PATH_MODEL = './results/test12/'
PATH_LOSS_IMAGE = './results/test12/loss.png'
PATH_L2_ERROR_IMAGE = './results/test12/l2_error.png'
PATH_LOSS_TXT = './results/test12/loss.txt'
PATH_L2_ERROR_TXT = './results/test12/l2_error.txt'
